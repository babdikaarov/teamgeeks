...
import useCollageModal from "../../../modules/hooks/useCollageModal";
import { ModalProps } from "./types";

const Modal: React.FC<ModalProps> = ({ modalId, images, index, setIndexImage, nextPage }) => {
   ...
   return (
      <dialog className={styles.modal} id={modalId} ref={dialogRef}>
         ...
         <div
            ref={imageRef}
            className={`${styles.modalContainer} ${styles.modalImage} ${
