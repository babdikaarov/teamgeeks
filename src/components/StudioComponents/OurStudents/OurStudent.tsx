    ...
    return (
        <div>
            ...
            <div className={styles.ConcertSlider}>
                ...
                <Swiper spaceBetween={0} slidesPerView={3} navigation={{ nextEl: '#btn11', prevEl: '#btn22' }} modules={[Navigation]}>
                    ...
                    <div id="btn22" className={styles.LeftSwip}>&lt;</div>
                    <div id="btn11" className={styles.RightSwip}>&gt;</div>
