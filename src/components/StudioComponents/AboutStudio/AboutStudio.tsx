        ...
        <div className={styles.TextWrapper}>
          ...
          {expanded && (
            <div className={`${styles.ExpandedText} ${expanded ? styles.expanded : ""}`}>
              ...
              уверенно, чтобы максимально раскрыть творческий потенциал каждого. <br />
              <br />
              Cool Studio - это место, где в тебя верят, где ты можешь быть собой, где ты можешь творить и мечтать. Нам
              уже 1 год, и это только начало
            </div>
          )}
          <button
