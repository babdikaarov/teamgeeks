...
import styles from "./_coolshowband.module.scss";
const CoolShowBand = () => {
  return (
      ...
      <div className={styles.block}>
        <div className={styles.box}>
          <div className={styles.show}>
            <h1 className={styles.title}>Cool band</h1>
            <p>
              Coolband- яркая команда настоящих профессионалов, состоящая из инструментального кавер-бэнда,
